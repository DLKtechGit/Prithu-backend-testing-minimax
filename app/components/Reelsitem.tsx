...
//           return;
//         }
//         const res = await fetch('http://192.168.1.66:5000/api/get/profile/detail', {
//           method: 'GET',
//           headers: {
...
//           ? 'http://192.168.1.66:5000/api/user/feed/like'
//           : 'http://192.168.1.66:5000/api/creator/feed/like';
...
//       const endpoint =
//         activeAccountType === 'Personal'
//           ? 'http://192.168.1.66:5000/api/user/feed/save'
//           : 'http://192.168.1.66:5000/api/creator/feed/save';
//       const res = await fetch(endpoint, {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',

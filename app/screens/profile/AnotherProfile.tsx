...
//         `http://192.168.1.6:5000/api/get/creator/detail/feed/${feedId}`,
//         {
//           headers: {
...
//         'http://192.168.1.6:5000/api/creator/get/post',
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
//           },
...
//                     "http://cdn-icons-png.flaticon.com/512/3135/3135715.png",
//                 }}
//               />
//             </View>
//           </TouchableOpacity>
...
//                     source={{
//                       uri: `http://192.168.1.6:5000/${item.videoThumb}`,
//                     }}
//                   />
//                 </TouchableOpacity>
//               </View>
...
const AnotherProfile = () => {
  ...
  const handleFollow = async () => {
    ...
    try {
      ...
      const res = await fetch(
        "http://192.168.1.6:5000/api/user/follow/creator",
        {
          method: "POST",
          headers: {
  ...
  const handleUnfollow = async () => {
    ...
    try {
      ...
      const res = await fetch(
        "http://192.168.1.6:5000/api/user/unfollow/creator",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",

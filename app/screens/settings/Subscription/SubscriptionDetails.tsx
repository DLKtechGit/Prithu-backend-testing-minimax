...
//     const [isCancelConfirm, setIsCancelConfirm] = useState(false); // State to track logout confirmation
...
//           onPress: async () => {
//             try {
//               const response = await fetch('http://192.168.1.6:5000/api/user/cancel/subscription', {
//                 method: 'PUT',
//                 headers: {

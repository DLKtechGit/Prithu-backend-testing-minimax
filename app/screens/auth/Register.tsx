...
const Register = ({ navigation }: RegisterScreenProps) => {
    ...
    const checkEmailAvailability = async (email: string) => {
        ...
        try {
            ...
            const res = await fetch(
                `http://192.168.1.7:5000/api/check/email/availability?email=${encodeURIComponent(email)}`,
                { method: 'GET' }
            );
    ...
    const sendOtp = async () => {
        ...
        try {
            const res = await fetch('http://192.168.1.7:5000/api/auth/user/otp-send', {
                method: 'POST',
    ...
    const verifyOtp = async () => {
        ...
        try {
            const res = await fetch('http://192.168.1.7:5000/api/auth/new/user/verify-otp', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const handleRegister = async () => {
        ...
        try {
            const res = await fetch('http://192.168.1.7:5000/api/auth/user/register', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },

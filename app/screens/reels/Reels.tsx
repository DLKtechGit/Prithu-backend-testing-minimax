...
// const REELS_CONTAINER_HEIGHT = 810;  //658
...
//           .map((feed: any) => ({
//             ...feed,
//             duration: feed.duration || 0, // Assume duration is provided by API
//           }));
...
//       const item = reelsData[prev];
//       const watched = watchedTimes.current[prev];
//       const minRequired = Math.floor(item.duration * 0.9);
//       if (watched >= minRequired) {
//         recordVideoView(item.feedId, watched);
//       }
//     }
...
//             const seconds = progress.currentTime || (progress.positionMillis / 1000) || 0;
